        ...
        <div className={hstack({ gap: '3' })}>
          ...
          <div>
            ...
            <p className={css({ fontSize: 'sm', color: 'gray.500' })}>
              Gestioná las sucursales y puntos de entrega de clientes
            </p>
          </div>
        </div>
                ...
                >
                  ...
                  <td className={css(tdStyle)}>
                    <div className={hstack({ gap: '1.5', color: 'gray.600' })}>
                      ...
                      <div className={stack({ gap: '0' })}>
                        <span
                          className={css({ fontSize: 'sm', fontWeight: '500' })}
                        >
                        ...
                        >
                          {sede.direccion} (CP: {sede.codigoPostal})
                        </span>
                      </div>
                    </div>
                  </td>
                  <td className={css(tdStyle)}>
                    <div className={stack({ gap: '0' })}>
                      <span
                        className={css({ fontSize: 'sm', fontWeight: '500' })}
                      >
                        {sede.contactoNombre || 'N/A'}
                      </span>
                      <span
                        className={css({ fontSize: 'xs', color: 'gray.400' })}
                      >
                        {sede.contactoTelefono || 'S/D'}
                      </span>
                    </div>
                  </td>
                  <td className={css(tdStyle)}>
