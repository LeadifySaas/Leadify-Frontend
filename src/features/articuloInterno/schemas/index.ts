...
export const articuloInternoSchema = z.object({
...
export type ArticuloInternoFormValues = z.infer<typeof articuloInternoSchema>;

export interface ArticuloInterno extends ArticuloInternoFormValues {
    id: number;
}