...
export default function ArticuloPage() {
  ...
  const { articulosQuery, deleteArticulo } = useArticulosInterno(page, size, search);
  ...
  return (
    <div className={stack({ gap: '6', p: '6' })}>
      ...
      <div className={hstack({ justifyContent: 'space-between' })}>
        ...
        <button
          onClick={() => navigate({ to: '/materiales/articulosInternos/nuevo' })}
          className={hstack({
            px: '5',
            py: '2.5',
            bgColor: 'blue.600',
        ...
        >
          <Plus size={18} /> Nuevo Artículo Interno
        </button>
      </div>
        ...
        >
          <thead>
            ...
            >
              ...
              <th className={css(thStyle)}>Precio Compra</th>
                ...
                >
                  ...
                  <td className={tdStyle}>
                    <span
                      className={css({ fontWeight: '600', color: 'green.600' })}
                    >
                      $ {(articulo.precioCompra || 0).toLocaleString('es-AR')}
                    </span>
                  </td>
                  <td className={tdStyle}>
                    <span
                  ...
                  <td className={`${tdStyle} ${css({ textAlign: 'center' })}`}>
                    ...
                    >
                      <button
                        ...
                        onClick={() =>
                          navigate({
                            to: '/materiales/articulosInternos/$id',
