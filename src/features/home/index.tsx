  ...
  return (
    <div className={stack({ gap: '8', p: '2' })}>
      ...
      >
        ...
        >
          <span className={css({ color: 'green.500', mr: '2' })}>●</span> EN
          VIVO
        </div>
      </div>
      {/* KPIs */}
      ...
      <div className={grid({ columns: { base: 1, lg: 12 }, gap: '6' })}>
        ...
        >
          <div className={hstack({ justifyContent: 'space-between', mb: '6' })}>
            <h3 className={hstack({ gap: '2', fontWeight: 'bold' })}>
              <BarChart3 size={18} /> Reporte Mensual de Ventas
            </h3>
          </div>
          <div
            className={hstack({
          ...
          >
            {[45, 60, 35, 90, 70, 55, 80, 35, 90, 70, 55, 80].map((h, i) => (
              <div
                key={i}
                className={stack({ flex: 1, gap: '2', alignItems: 'center' })}
              >
                <div
                  className={css({
                    width: '100%',
        ...
        >
          <h3 className={hstack({ gap: '2', fontWeight: 'bold', mb: '6' })}>
            <ListChecks size={18} /> Metas por Sede
          </h3>
        ...
        >
          ...
          <div className={stack({ gap: '1' })}>
            ...
            <ActivityItem
              user="Fausto"
              action="exportó PDF"
              detail="Reporte Marzo"
              time="hace 1 hora"
            />
            <ActivityItem
              user="Jose"
              action="actualizó clave"
              detail="Seguridad"
              time="hace 2 horas"
            />
          </div>
  ...
  return (
    <div className={stack({ gap: '1.5' })}>
      <div className={hstack({ justifyContent: 'space-between' })}>
        ...
        <span
          className={css({ fontSize: 'xs', fontWeight: '800', color: color })}
        >
          {value}%
        </span>
      </div>
    ...
    >
      ...
      <div className={stack({ gap: '0.5', flex: 1 })}>
        <div className={hstack({ justifyContent: 'space-between' })}>
          ...
          >
            <strong className={css({ fontWeight: '800', color: '#1A365D' })}>
              {user}
            </strong>{' '}
            {action}
          </p>
